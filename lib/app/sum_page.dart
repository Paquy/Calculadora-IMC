...
class _SumPageState extends State<SumPage> {
  ...
  List<FaixaModel> faixas = [
    FaixaModel(nome: 'Magreza', percentual: 18.5, cor: Colors.yellow.shade100) ,
    FaixaModel(nome: 'Normal', percentual: 24.9, cor: Colors.green.shade100),
    FaixaModel(nome: 'Sobrepeso', percentual: 29.9, cor: Colors.orange.shade100),
    FaixaModel(nome: 'Obesidade', percentual: 30.0, cor: Colors.red.shade100),
  ];
